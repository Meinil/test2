...
Page({
  ...
  // onLoad 是在页面加载时触发
  // 如果当前页面没有销毁， onLoad 钩子函数只会触发一次
  // 如果点击了新增，编辑，不会销毁当前页面然后进行新增，编辑页面
  //在新增，编辑以后，返回到列表页面，这时候 onLoad 不会触发执行，就不会获取最新数据
  onLoad (options) {
