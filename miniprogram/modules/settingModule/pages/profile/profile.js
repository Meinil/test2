...
import { reqUploadFile,reqUpdateUserInfo, reqUserInfo } from '../../../../api/user'
...
Page({
  ...
  async chooseAvatar(event) {
    ...
    //第二种本地资源上传的方式：使用 mina-request 提供的 upload 实例方法
    ...
    //第一种实现本地资源上传的方式
    //在获取头像路径以后，需要将临时路径通过 wx.uploadFile 上传到服务器
    // wx.uploadFile({
    //   url: 'https://gmall-prod.atguigu.cn/mall-api/fileUpload',   //开发者服务器
